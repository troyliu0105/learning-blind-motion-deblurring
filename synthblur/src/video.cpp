...
#define CV_CAP_PROP_POS_FRAMES    cv::VideoCaptureProperties::CAP_PROP_POS_FRAMES
#define CV_CAP_PROP_FPS           cv::VideoCaptureProperties::CAP_PROP_FPS
#define CV_CAP_PROP_FRAME_WIDTH   cv::VideoCaptureProperties::CAP_PROP_FRAME_WIDTH
#define CV_CAP_PROP_FRAME_HEIGHT  cv::VideoCaptureProperties::CAP_PROP_FRAME_HEIGHT
#define CV_CAP_PROP_FRAME_COUNT   cv::VideoCaptureProperties::CAP_PROP_FRAME_COUNT
#define CV_CAP_PROP_POS_FRAMES    cv::VideoCaptureProperties::CAP_PROP_POS_FRAMES
